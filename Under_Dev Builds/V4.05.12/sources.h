...
{//layout done
    ...
    gotoxy(5,9);
    cout<<bold<<blue<<"i.)Functional border changer";
    // gotoxy(5,10);
...
void color_change()
{
    ...
    layout();
    gotoxy(5,10);
    cout<<"Welcoem to bakgrouund color change wizard.";  gotoxy(5,11);
    cout<<"FOllow the option below.";  gotoxy(5,12);
    cout<<"1.) Green";  gotoxy(5,13);
    cout<<"2.) RED";  gotoxy(5,14);
    cout<<"3.) BLUE";  gotoxy(5,15);
    cout<<"4.) yellow";  gotoxy(5,16);
    cout<<"5.) white";  gotoxy(5,17);
    cout<<"Enter choice: ";string color;  gotoxy(5,18);
    cin>>color;
    if(color=="1")
    {
       fstream color;
