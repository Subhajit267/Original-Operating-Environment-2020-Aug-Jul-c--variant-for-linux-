...
{//layout done
    ...
    gotoxy(5,9);
    cout<<bold<<blue<<"i.)New logo and new background changer Wizard(currently non functional).";
    // gotoxy(5,10);
    ...
    // gotoxy(5,22);
    // cout<<bold<<green<<"New logo is introduced with new sub category in settings app"<<cc;
    getchar();
}
...
{
    system("clear");
    cout<<"Welcoem to bakgrouund color change wizard.";
    cout<<"\nFOllow the option below.";
    cout<<"\n1.) Green";
    cout<<"\n2.) RED";
    cout<<"\n3.) BLUE";
    cout<<"\n4.) yellow";
