...
void solve()//To solve the equations using cross multiplication method
{
    ...
    cout<<"("<<A1<<")x + ("<<B1<<")y + ("<<C1<<") = 0 n"; gotoxy(5,30);
    cout<<"("<<A2<<")x + ("<<B2<<")y + ("<<C2<<") = 0 "; gotoxy(5,31);
    cout<<"X = \033[31m"<<x<<"\033[0;1m and Y = \033[31m"<<y; gotoxy(5,32);
    cout<<"They represent equations with unique solution intersecting at a point on graph.";
    cout<<cc<<cc;
}                 
...
void get_Eqn()//to get the equation
{
   ...
   gotoxy(5,6);
    ...
    { gotoxy(5,26);
        cout<<"Solution can be given only to equations with unique solution."; gotoxy(5,27);
...
{       gotoxy(1,1);
    layout();
    gotoxy(5,7);
      cout << "\t\t\t\t\t"<<bold<<UNDERLINE<<RED<<"Select Game Mode(1/2)."<< CLOSEUNDERLINE<<cc<<CLOSEUNDERLINE;    gotoxy(5,9);
    cout << "  \t\t\t\t\t\x1B[94m1. Computer VS Player." ;    gotoxy(5,10);
    cout << "  \t\t\t\t\t2. Player VS Player." << CLOSEUNDERLINE;    gotoxy(5,11);
    ...
    switch(mode)
        ...
        case 1 :
            ...
            cout<<RED<<bold<<"Enter Game type:"<<cc;
                gotoxy(5,13);
            cout<<yellow<<"\ta.)Simple.";    gotoxy(5,14);
            cout<<"\tb.)Difficult."<<cc;gotoxy(5,15);
...
void computer_vs_player() {
    ...
    layout();
    gotoxy(5,7);
    cout<<red<<bold<<"Please fill in the following details:"<<CLOSEUNDERLINE;gotoxy(5,8);
...
void player_vs_player() {
    ...
    gotoxy(1,1);layout();
    gotoxy(5,7);
    cout<<red<<bold<<"Please fill in the following details:"<<cc;gotoxy(5,8);
    cout <<yellow<<"Enter X Player Name: " <<CLOSEUNDERLINE;
    cin >> x_player_name;gotoxy(5,9);
    cout << yellow<<"Enter O Player Name: "<<CLOSEUNDERLINE ;
    cin >> o_player_name;
    while(true) {
        system("clear");
        show_board();
        if(count_board('X') == count_board('O')) {gotoxy(5,19);
...
{layout();
    gotoxy(5,7);
    cout<<green<<"   "<<"    |   "<<"    |   "<<cc;gotoxy(5,8);
    cout<<green<<"   "<<cc<<red<<board[0]<<cc<<green<<"   |   "<<cc<<red<<board[1]<<cc<<green<<"   |   "<<cc<<red<<board[2]<<cc;gotoxy(5,9);
     cout<<green<<"   "<<"    |   "<<"    |   ";gotoxy(5,10);
    cout<<"-----------------------";gotoxy(5,11);
     cout<<"   "<<"    |   "<<"    |   ";gotoxy(5,12);
    cout<<cc<<"   "<<red<<board[3]<<cc<<green<<"   |   "<<cc<<red<<board[4]<<cc<<green<<"   |   "<<cc<<red<<board[5]<<cc;gotoxy(5,13);
     cout<<green<<"   "<<"    |   "<<"    |   ";gotoxy(5,14);
       cout<<"-----------------------";gotoxy(5,15);
     cout<<"   "<<"    |   "<<"    |   ";gotoxy(5,16);
    cout<<"   "<<cc<<red<<board[6]<<cc<<green<<"   |   "<<cc<<red<<board[7]<<cc<<green<<"   |   "<<cc<<red<<board[8]<<cc;gotoxy(5,17);
     cout<<green<<"   "<<"    |   "<<"    |   "<<cc;
}
...
void tc()//a basic decent temperature converter
{
    ...
    int temp,temp_c;  gotoxy(5,9);
    cout<<green<<bold"Enter your desired unit of temperature:(°C/°F/K):";
    cin>>choice;
      gotoxy(5,10);
  cout<<cyan<<bold"Enter temperature ("<<choice<<"): ";
    cin>>temp;
    
    if(choice=='C' || choice=='c')
    {
        temp_c=(temp * 1.8) + 32; gotoxy(5,11);
        cout<<"Temperature in °F is:"<<temp_c; gotoxy(5,12);
       cout<<"Temperature in °K is:"<<temp + 273;
    }
    else if(choice=='F' || choice=='f')
    {
        temp_c=(temp - 32) * 5/9 ; gotoxy(5,11);
        cout<<"Temperature in °C is:"<<temp_c; gotoxy(5,12);
        cout<<"Temperature in °K is:"<<temp_c + 273;
    }
     else if(choice=='K' || choice=='k')
    {
        temp_c=(temp - 273); gotoxy(5,11);
        cout<<"Temperature in °C is:"<<temp_c;
        temp_c=(temp_c * 1.8) + 32; gotoxy(5,12);
...
int printawon()
{     A = 45; B = 0;gotoxy(1,1);layout();                     //To count marks this section is used
gotoxy(5,7);
              cout<<"Correct Answers:";gotoxy(5,8);
              cout<<"1.) C";gotoxy(5,9);
              cout<<"2.) A";gotoxy(5,10);
              cout<<"3.) C";gotoxy(5,11);                   // At first declaring all the correct options of all uestion
               cout<<"4.) D";gotoxy(5,12);
             cout<<"5.) B";gotoxy(5,13);
              cout<<"6.) A";gotoxy(5,14);
                cout<<"A won";gotoxy(5,15);
                cout<<" A="<<A<<"\tB="<<B;
                 getchar();
                  printerror1();
}
...
int cheatcode()
{gotoxy(1,1);layout();gotoxy(5,8);
      cout<<"\x1B[31mEvery Game has certain cheat codes or cheat sheets\033[0m";gotoxy(5,9);
      cout<<"Quiz ver:10.8 is also having it as it is a quiz game.";gotoxy(5,10);
      cout<<"List of All correct answers.";gotoxy(5,11);
    cout<<"Correct Answers:";gotoxy(5,12);
    cout<<"\n1.) C";gotoxy(5,13);
    cout<<"\n2.) D";gotoxy(5,14);
    cout<<"\n3.) C";   gotoxy(5,15);                
    cout<<"\n4.) B";gotoxy(5,16);
...
gotoxy(20,8);
   ...
   gotoxy(20,9);
  cout <<"\t\t\t\t\t     " <<yellow<<UNDERLINE<<"Version:10.01"<<CLOSEUNDERLINE;gotoxy(20,10);
  cout << "\t\t\t\t\t    "<<green<<UNDERLINE<<"(Round: 1 - 4 )"<<CLOSEUNDERLINE<<cc<<cc;gotoxy(5,11);
  cout <<red<<bold "General Instructions:"<<cc<<cc;
  gotoxy(85,11);
  cout << purple<<bold"Marking Scheme:"<<cc<<cc;gotoxy(5,12);
  cout << "a.) This quiz has 4 rounds";gotoxy(85,12);
  cout << "i.) Each C.A. 10m";gotoxy(5,13);
  cout << "b.) Each group can answer 4 questions";gotoxy(85,13);
  cout << "ii.) Each W.A. -5m";gotoxy(5,14);
  cout << "c.) Two groups can attempt the quiz";gotoxy(85,14);
  cout << "iii.) Each U.A. 0m";gotoxy(5,15);
  cout << "d.) To Unattempt a question type letter 'u' other than the option.";gotoxy(85,15);
  cout << "iv.) Each B.A. 5m";gotoxy(5,16);
  cout<<"e.)Each question must be answered in 20 seconds(for originals)";gotoxy(5,17);
  cout<<"f.)Each bonus question must be answered in 05 seconds";gotoxy(25,21);
  cout<<cyan<<bold<< "Used Short Abbreviations:"<<cc;gotoxy(85,21);
  cout<<Yellow <<"New Improvements and bug fixes:"<<cc;gotoxy(25,22);
  cout<<"1.) C.A. = Correct answer";gotoxy(85,22);
  cout<<"1.) SOURCE CODE VIEW";gotoxy(25,23);
  cout<<"2.) W.A. = Wrong answer";gotoxy(85,23);
    cout<<"3.) U.A. = Unattempted answer";gotoxy(85,24);
     cout<<"4.) B.A. = Bonus answer";gotoxy(85,27);
     cout<<green<<bold<<"QUIZ MASTER: Subhajit Halder";gotoxy(25,27);
...
void quad_eqn_solve()
{gotoxy(1,1);layout();gotoxy(5,8);
    cout<<green<<bold<<UNDERLINE<<"Welcome to Quadratic Eqn Solver Ver: 1.0"<<CLOSEUNDERLINE<<endl;gotoxy(5,9);
    cout<<Yellow<<bold<<"Your equations must be in the form of ax^2+bx+c=0"<<cc<<cc;
    double d,a,b,c,r1,r2;gotoxy(5,11);
    ...
    cout<<"Equation you entered id having real and unequal roots. Roots are: "<<r1<<" and "<<r2; 
        gotoxy(5,16);
        cout<<"It may happen that the answer provided by computer is not matching. Possible reasons are:"; gotoxy(5,17);
        cout<<"a.) The answer has imperfect square numbers"; gotoxy(5,18);
