 ...
 system("clear");
  system("clear");
   system("clear");
    ...
    cout <<"\x1B[36m\x1B[1m  "<<UNDERLINE<< "\n\t\t\t\t\t\tTicTacToe \033[0m"<<CLOSEUNDERLINE;//cyan
  cout <<"\n\t\t\t\t\t     "<<"  Version:3.05";
...
void selector_t()
{
     ...
     sleep(1.5);
      ...
      system("clear");
      cout << ", Select Game Mode(1/2)."<< CLOSEUNDERLINE<<cc<<CLOSEUNDERLINE<<endl;
...
std::srand(time(NULL)); //seed random 
	for(int progress=0;progress!=100;progress+=std::rand()%20){
	    gotoxy(40,12);//increment progress randomly 
		//Delete the line below and change for loop condition to 'progress<=100' and put something meaningful in for loop progress increment in implementation. 
		if(progress>25) progress=25; 
...
system("clear");
    system("clear");
    system("clear");
    cout <<"\x1B[96m\x1B[1m  "<< "\n\t\t\t\t\t      "<<UNDERLINE<<" TicTacToe \033[0m"<<CLOSEUNDERLINE;//cyan
  cout <<"\n\t\t\t\t\t     "<<"Version:3.05";

   cout<<blue<< "\n\n\t\t\t     !!!Welcome to latest build of TicTacToe!!!"<<cc;
    
  cout<<UNDERLINE<<red<<bold<<"\n\nWhile the game is loading let us know its working:"<<CLOSEUNDERLINE;
   cout<<yellow<<"\n\nAt first follow the onscreen instructions.";
   cout<<"\nFor selecting a position type its number(1-9). "<<CLOSEUNDERLINE;
   cout<<purple<<"\t\tDesingned for ease"<<cc;
   cout<<yellow<<"\nIf one choose incorrect option"<<cc;
   cout<<purple<<"\t\t\t\tFor computer vs human "<<cc;
   cout<<yellow<<"\nthen again position can be selected."<<cc;
    cout<<purple<<"\t\t\tand multiplayer"<<cc;
    cout <<cyan<<"\n\n\n\t\t\t\t\t      Please Wait.";
  cout <<"\n\t\t\t\t\t      Loading....."<<cc;
...
cout <<UNDERLINE<< "\t\t\t\t\t\tTIC TAC TOE"<<CLOSEUNDERLINE;
  cout <<"\n\t\t\t\t\t      "<<"  Version:3.05";
  cout << "\n\t\t\t\t\t  "<<"  (Evaluation_Build)";
      cout<<"\nAfter completeion of your game the program will stop. You have to restart the setup to continue.";
    login_t();
      }
      else
      {
...
void bootscreen_tc()
{
    ...
    system("clear");
    system("clear");
    cout <<"\x1B[36m\x1B[1m  "<< "\t\t\t\t\t       "<<UNDERLINE<<" TEMP_CONV \033[0m"<<CLOSEUNDERLINE;//cyan
  cout <<"\n\t\t\t\t\t       "<<"Version:01.01";

   cout<<"\n\n\t\t\t     !!!Welcome to latest build of TEMP_CONV!!!";
...
using namespace std;
int A,B,a1,a2,a3,a4,a5,b1,b2,b3,b4,b5,bo1,bo2,bo3,bo4,bo5,bo6,bo7,bo8;//As more questions would be added name them as a5 for groupA and b5 for goupB
...
void bootscreenq()
{
  system("clear");
      ...
      system("clear");
  cout <<UNDERLINE<< "\t\t\t\t\t\t QUIZ APP"<<CLOSEUNDERLINE;
  cout <<"\n\t\t\t\t\t      "<<"  Version:10.0";
  cout << "\n\t\t\t\t\t  "<<"  (Evaluation_Build)";
    cout <<"\n\n\n\t\t\t\t\t        Please_Wait.";
     cout <<"\n\n\t\t\t\t\t        Loading.....";
 ...
 system("clear");
  system("clear");
   system("clear");
    ...
    cout <<"\x1B[36m\x1B[1m  "<<UNDERLINE<< "\n\t\t\t\t\t\t  QUIZ  \033[0m"<<CLOSEUNDERLINE;//cyan
  cout <<"\n\t\t\t\t\t     "<<"  Version:10.5";
...
system("clear");
    system("clear");
    system("clear");
    cout <<"\x1B[96m\x1B[1m  "<< "\n\t\t\t\t\t      "<<UNDERLINE<<" QUIZ__APP \033[0m"<<CLOSEUNDERLINE;//cyan
  cout <<"\n\t\t\t\t\t     "<<"Version:3.05";

   cout<<blue<< "\n\n\t\t\t     !!!Welcome to latest build of QUIZ APP!!!"<<cc;
    
  cout<<UNDERLINE<<red<<bold<<"\n\nWhile the game is loading let us know its working:"<<CLOSEUNDERLINE;
   cout<<yellow<<"\n\nAt first follow the onscreen instructions.";
   cout<<"\nFor selecting an option from given on the screen. "<<CLOSEUNDERLINE;
   cout<<purple<<"\t\tDesingned for ease"<<cc;
   cout<<yellow<<"\nIf one choose incorrect option"<<cc;
   cout<<purple<<"\t\t\t\tFor multipgroup "<<cc;
   cout<<yellow<<"\nthen bonus will popup."<<cc;
    cout<<purple<<"\t\t\tquizes"<<cc;
    cout <<cyan<<"\n\n\n\t\t\t\t\t      Please Wait.";
  cout <<"\n\t\t\t\t\t      Loading....."<<cc;
  cout<<green<<"\t\tDEVELOPER:"<<RED<<" Subhajit Halder";
...
void prompt()
{
    ...
    cout<<"\nOperating Environment ver:1.0";
   
    cout<<cc<<CLOSEUNDERLINE<<bold<<blue;
    ...
    while(true)
    {
        ...
        if(command=="Help"||command=="HELP"||command=="help")
        {
            ...
            cout<<"\n\tMore features coming in next version";
